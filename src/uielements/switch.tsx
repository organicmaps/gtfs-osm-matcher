 ...
 * feature, not one.
 */
export function OsmMatchesSwitch() {
    const { osmMatchesOn, setOsmMatchesOn, osmMatchesAvailable } = useContext(OsmMatchesOptionsContext);
    ...
    if (!osmMatchesAvailable) {
        return null;
    }
    return (
        <Switch checked={osmMatchesOn} onChange={setOsmMatchesOn} label={'Move GTFS to anchors'}
